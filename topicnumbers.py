"""
2- NÚMEROS
En el topic numbers se están publicando constantemente números,los hay enteros
...
calcular la frecuencia de cada uno de ellos, estudiar propiedades 
(como ser o no primo) en los enteros, etc.
"""
